...
{{-- role="status" so the confirmation is announced when script swaps it in;
     the heading takes focus (see app.js) so a keyboard user lands here. --}}
<div role="status" class="flex flex-col items-start gap-[14px] rounded-[20px] border border-accent/25 bg-surface px-9 py-10">
    <span class="grid h-13 w-13 place-items-center rounded-[14px] bg-accent/15 text-accent">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <path d="M20 6 9 17l-5-5" />
        </svg>
    </span>
    <h3 tabindex="-1" class="font-display text-[23px] font-semibold">Message sent</h3>
